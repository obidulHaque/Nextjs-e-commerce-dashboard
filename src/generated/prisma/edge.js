...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/obaidul/Desktop/Nextjs-e-commerce-dashboard/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/obaidul/Desktop/Nextjs-e-commerce-dashboard/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres.jncaktupgohoxzgjtzau:XJB11qy5LLJswjZQ@aws-0-us-east-2.pooler.supabase.com:6543/postgres"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider  = \"postgresql\"\n  url       = env(\"DATABASE_URL\")\n  directUrl = env(\"DIRECT_URL\")\n}\n\nmodel Store {\n  id        String   @id @default(uuid())\n  name      String\n  userId    String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "2d2809be7f5433d4ee96da9df5f28fefc9e8d35e95b1a327dc52673885c4fb73",
  "copyEngine": true
}
config.dirname = '/'
